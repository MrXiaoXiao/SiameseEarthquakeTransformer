...
def get_ori_response_list(cfgs, spt_t_eqt, sst_t_eqt, encoded_t, encoded_s):
    ...
    for rdx in range(len(RSRN_lengths)):
        ...
        ori_response_list.append(np.copy(encoded_t[rdx]))
        ori_response_list.append(np.copy(encoded_s[rdx]))
        
    return ori_response_list
